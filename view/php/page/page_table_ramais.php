          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                  <h3>Lista de Ramais</h3><small><a href='/intra/file/pabx.pdf' target="_blank">Comandos do PABX clique aqui</a></small>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php require($path.'/intra/view/php/table/table_ramais.php');?>
                  </div>
                </div>
              </div>
            </div>
...
<?php require($path.'/intra/view/php/footer_script.php') ?><!--scripts do rodapé-->
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.8.2/jquery.modal.js"></script>
    ...
    <script src="/intra/controller/js/pageTableProposta.js"></script>
